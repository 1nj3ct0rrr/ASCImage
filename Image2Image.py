...
def Banner():
    print(f'{Fore.YELLOW}  _______  _______  _______  ___   __   __  _______  _______  _______  {Fore.RED}       {Fore.BLUE}    ___   __   __  _______  _______  _______  _______  ___   __   __  _______  _______  _______ ')
    print(f'{Fore.YELLOW} |   _   ||       ||       ||   | |  |_|  ||   _   ||       ||       | {Fore.RED}       {Fore.BLUE}   |   | |  |_|  ||   _   ||       ||       ||       ||   | |  |_|  ||   _   ||       ||       |')
    print(f'{Fore.YELLOW} |  |_|  ||  _____||       ||   | |       ||  |_|  ||    ___||    ___| {Fore.RED}  ____ {Fore.BLUE}   |   | |       ||  |_|  ||    ___||    ___||____   ||   | |       ||  |_|  ||    ___||    ___|')
    print(f'{Fore.YELLOW} |       || |_____ |       ||   | |       ||       ||   | __ |   |___  {Fore.RED} |____|{Fore.BLUE}   |   | |       ||       ||   | __ |   |___  ____|  ||   | |       ||       ||   | __ |   |___ ')
    print(f'{Fore.YELLOW} |       ||_____  ||      _||   | |       ||       ||   ||  ||    ___| {Fore.RED}       {Fore.BLUE}   |   | |       ||       ||   ||  ||    ___|| ______||   | |       ||       ||   ||  ||    ___|')
    print(f'{Fore.YELLOW} |   _   | _____| ||     |_ |   | | ||_|| ||   _   ||   |_| ||   |___  {Fore.RED}       {Fore.BLUE}   |   | | ||_|| ||   _   ||   |_| ||   |___ | |_____ |   | | ||_|| ||   _   ||   |_| ||   |___ ')
    print(f'{Fore.YELLOW} |__| |__||_______||_______||___| |_|   |_||__| |__||_______||_______| {Fore.RED}       {Fore.BLUE}   |___| |_|   |_||__| |__||_______||_______||_______||___| |_|   |_||__| |__||_______||_______|')
...
def GetArgs():
    ...
    parser.add_argument('--column', type = int, default = 200, help = 'Number of characters for output\'s width')
