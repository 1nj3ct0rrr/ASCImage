...
def Banner():
    ...
    print(
        f'{Fore.YELLOW} |       || |_____ |       ||   | |       ||       ||   | __ |   |___  {Fore.RED} |____|{Fore.BLUE}   |   | |       ||       ||   | __ |   |___  ____|  |  |   |  |   |___ |       |  |   |  '
    )
    print(
        f'{Fore.YELLOW} |       ||_____  ||      _||   | |       ||       ||   ||  ||    ___| {Fore.RED}       {Fore.BLUE}   |   | |       ||       ||   ||  ||    ___|| ______|  |   |  |    ___| |     |   |   |  '
    )
    print(
        f'{Fore.YELLOW} |   _   | _____| ||     |_ |   | | ||_|| ||   _   ||   |_| ||   |___  {Fore.RED}       {Fore.BLUE}   |   | | ||_|| ||   _   ||   |_| ||   |___ | |_____   |   |  |   |___ |   _   |  |   |  '
    )
    print(
        f'{Fore.YELLOW} |__| |__||_______||_______||___| |_|   |_||__| |__||_______||_______| {Fore.RED}       {Fore.BLUE}   |___| |_|   |_||__| |__||_______||_______||_______|  |___|  |_______||__| |__|  |___|  '
    )
